        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
               <h5 class="text-center">EVERY GIRLS DREAM</h5>
            <div class="brand-logo d-flex justify-content-center align-items-center">
                <img src="images/girls_bg.jpg" alt="logo">
              </div>
              <h4 class="text-center">Admin Login</h4>
              <h6 class="font-weight-primary text-center">Sign in to continue.</h6>
              ...
              <?php include('errors.php'); ?>
                ...
                <div class="mt-3">
                  <Button class="btn btn-block btn-primary btn-lg font-weight-primary auth-form-btn" name="login_user" type="submit">SIGN IN</Button>
                </div>
              </form>
            </div>
          </div>
