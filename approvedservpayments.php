        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Emergency Reports (In Progress) </h4>
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                      <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $select="SELECT * FROM emergency_reports WHERE emergency_status = 'In Progress'";
                                            ...
                                            while($row=mysqli_fetch_array($query)){
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><?php echo $row['number_of_girls']?> </td>
                                                    <td><?php echo $row['emergency_status']?> </td>
                                                    <td><?php echo $row['assigned_team']?> </td>
