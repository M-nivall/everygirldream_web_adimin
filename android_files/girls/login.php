...
if ($_SERVER['REQUEST_METHOD'] =='POST') {
    ...
    if ( empty($username) ||empty($password)) {
        ...
        $select = "SELECT girl_id, first_name, last_name, username, phone_no, email, status,
       date_created, remarks,user FROM girls WHERE username='$username' AND password='$password'";
